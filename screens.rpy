...
screen main_menu():
    ...
    imagebutton:
        idle "images/misc/bpatreonidle.png"
        hover "images/misc/bpatreonhover.png"
        action OpenURL("https://www.patreon.com/ionDivvy")
        xalign 0.035
        yalign 0.21
    imagebutton:
        idle "images/misc/discordidle.png"
        hover "images/misc/discordhover.png"
        action OpenURL("https://discord.gg/qY67DmkYWH")
        xalign 0.03
        yalign 0.13

    imagebutton:
        idle "images/misc/rdpromoidle.png"
        hover "images/misc/rdpromohover.png"
        action OpenURL("https://store.steampowered.com/app/2676930/Rebel_Duet/")
        xalign 0.01
        yalign 0.94
...
screen savegameName(accept=NullAction()):
    ...
    frame:
        ...
        textbutton _("{u}Click to Save{/u}"):
            xalign 0.5
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "radio"
                    label _("Extras")
                    textbutton _( "Lesbian Mode" ) action ToggleVariable ("lesonly", true_value=True, false_value=False)
                    #textbutton _( "Compact UI" ) action ToggleVariable ("compactui", true_value=True, false_value=False)
